    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('dashboard') }}" class="d-lg-none">
                <img alt="Logo" src="{{ asset('admin/media/logos/logo.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item">
                            <span class="fa fa-chevron-right bg-gray-200 w-5px text-muted"></span>
                        </li>
                        <!--end::Item-->
                        @if(isset($breadcrums))
                        @foreach($breadcrums as $breadcumindex=>$breadcrum)
                        @if(isset($breadcrum['link']))
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ url($breadcrum['link']) }}" class="text-muted text-hover-primary">{{
                                $breadcrum['name'] }}</a>
                        </li>
                        <!--end::Item-->
                        @else
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">{{ $breadcrum['name'] }}</li>
                        <!--end::Item-->
                        @endif
                        @if(count($breadcrums) > 1 && (count($breadcrums) != $breadcumindex + 1))
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="fa fa-chevron-right bg-gray-200 w-5px text-muted"></span>
                        </li>
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            ...
                            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                style="background-image:url('{{ asset('admin/media/misc/pattern-1.jpg') }}')">
                                <!--begin::Title-->
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <a href="javascript:;" class="fw-bold text-muted text-hover-primary fs-7">{{
                                            Auth()->user()->email ?? "example@mail.com" }}</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
